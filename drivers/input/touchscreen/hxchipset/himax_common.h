...
#define HIMAX_DRIVER_VER "2.0.0.81_M10_01"
...
#define PANEL_PORTRAIT_0		1
#define PANEL_LANDSCAPE_90		2
...
#define DRIVER_NAME "himax_penraw_driver"
...
struct himax_ts_data {
	...
	uint8_t direction;
	uint8_t game_mode;		//OAK4146,shenwenbin.wt,ADD,20220125,add TP game mode
	int32_t cmd_param[4];	//OAK4139,shenwenbin.wt,ADD,20220217,improve virtual bar edge restrain
...
/******* SPI-end *******/
	...
	struct notifier_block notifier_charger;	//OAK700,shenwenbin.wt,MOD,20211201,TP usb mode function
#endif
...
int himax_self_test(struct seq_file *s, void *v);	//bug692121,shenwenbin.wt,MOD,20211015,bringup selftest function
